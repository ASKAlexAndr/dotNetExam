            ...
            public int score {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'score\' в таблице \'ViewScore\' равно DBNull.", e);
                    }
                }
                set {
...
SELECT Id, name, surname, login, password FROM Users WHERE (Id = @Id)";
    ...
    public partial class ViewScoreTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            this._connection = new global::System.Data.SqlClient.SqlConnection();
            this._connection.ConnectionString = global::Exam.Properties.Settings.Default.ExamDBConnectionString2;
        }
